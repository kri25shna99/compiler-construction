...
FILE =  lexer.java parser.java sym.java \
        ...
        Memberdecls.java Program.java Fielddecls.java \
        Methoddecls.java Methoddecl.java Fielddecl.java \
        ArgdeclList.java Argdecls.java Argdecl.java \
        Stmts.java Stmt.java Name.java \
        Readlist.java Args.java Printlist.java \
        Printlinelist.java Expr.java BinaryOp.java
